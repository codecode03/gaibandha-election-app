...
const CONTACTS_DATA: Record<string, {
  ...
  '31-palashbari': {
    ...
    contacts: [
      ...
      { designation: 'অফিসার ইনচার্জ-তদন্ত (ওসি তদন্ত)', mobile: '০১৩২০-১৩২৪৫৫/০১৭১৬-২১৪৬৪০' },
      { designation: 'সেনাবাহিনী/মেজর আতিক', mobile: '০১৭৬৯-৬৬০১৪৭' },
      { designation: 'বিজিবি/এডি', mobile: '০১৭৬৯-৬০২৩৪৫' },
      { designation: 'উপজেলা নির্বাচন অফিসার', mobile: '০১৭৮৭-১৮৮৯৮২' },
      { designation: 'উপজেলা আনসার ও ভিডিপি অফিসার', mobile: '০১৭২৯-৪৬১১৭২' },
      { designation: 'উপজেলা শিক্ষা অফিসার', mobile: '০১৯৪৮-৯০৪৪০৬' },
      { designation: 'উপজেলা মাধ্যমিক শিক্ষা অফিসার', mobile: '০১৭৯৪-২০৮৯৮০' },
    ],
  },
  // Sadullapur Upazila
  '31-sadullapur': {
    ...
    contacts: [
      ...
      { designation: 'উপজেলা আনসার ও ভিডিপি অফিসার', mobile: '০১৭২৪-১৪২৭৪৭' },
      { designation: 'উপজেলা শিক্ষা অফিসার', mobile: '০১৭১৬-০৩৯৮২৯' },
      { designation: 'উপজেলা মাধ্যমিক শিক্ষা অফিসার', mobile: '০১৭৩১-২৮৫০৫০' },
    ],
  },
  // Sundarganj Upazila
  '29': {
    ...
    contacts: [
      ...
      { designation: 'সেনাবাহিনী', mobile: '০১৭৬৯-৬৬০১৪৭' },
      { designation: 'বিজিবি', mobile: '০১৭৩৭-২৭০৬৭৯' },
      { designation: 'উপজেলা নির্বাচন অফিসার', mobile: '০১৭১৯-১০৪৬৩২' },
      { designation: 'উপজেলা আনসার ও ভিডিপি অফিসার', mobile: '০১৫৫৮-৯১৯৫৪৪' },
      { designation: 'উপজেলা শিক্ষা অফিসার', mobile: '০১৭১৮-৪০৮০২৪' },
      { designation: 'উপজেলা মাধ্যমিক শিক্ষা অফিসার', mobile: '০১৭৩১-২৮৫০৫০' },
    ],
  },
  ...
  '30': {
    ...
    contacts: [
      ...
      { designation: 'উপজেলা প্রাথমিক শিক্ষা অফিসার', mobile: '০১৭১৫২৭১৭১৮' },
      { designation: 'উপজেলা মাধ্যমিক শিক্ষা অফিসার (অ:দা:) ও জেলা শিক্ষা অফিসার', mobile: '০১৭১২-৬৭৫৭৩৭' },
      { designation: 'উপজেলা আনসার ও ভিডিপি অফিসার', mobile: '০১৭২২-৬২৬৩১৮' },
    ],
  },
  // Gobindaganj Upazila
  '32': {
    ...
    color: '#0e7490',
    contacts: [
      { designation: 'উপজেলা নির্বাহী অফিসার', mobile: '০১৭৬২-৬৯৫০৭২' },
      { designation: 'সহকারী কমিশনার (ভূমি)', mobile: '০১৭৬২-৬৯৫০৭৯' },
      { designation: 'অফিসার ইনচার্জ (ওসি)', mobile: '০১৩২০-১৩২৪৮০' },
      { designation: 'অফিসার ইনচার্জ-তদন্ত (ওসি তদন্ত)', mobile: '০১৩২০-১৩২৪৮১' },
      { designation: 'সেনাবাহিনী', mobile: '' },
      { designation: 'বিজিবি', mobile: '' },
      { designation: 'উপজেলা নির্বাচন অফিসার', mobile: '০১৭৮০-৬০৩০৮৯৮' },
      { designation: 'উপজেলা আনসার ও ভিডিপি অফিসার', mobile: '০১৭৯০-৭১৫৫০৬' },
      { designation: 'উপজেলা শিক্ষা অফিসার', mobile: '০১৭৯২-৬৭৫৪৫৯' },
      { designation: 'উপজেলা মাধ্যমিক শিক্ষা অফিসার', mobile: '০১৭১২-২৩৬৬১৭' },
    ],
  },
  // Saghata Upazila
  '33-saghata': {
  ...
  '33-fulchari': {
    ...
    contacts: [
      ...
      { designation: 'উপজেলা আনসার ও ভিডিপি অফিসার', mobile: '০১৭১৭-৯৪৫২৮৬/০১৭১৮-৮৭৬৫২২' },
      { designation: 'উপজেলা শিক্ষা অফিসার', mobile: '০১৭৪১-২২৬৯১১' },
      { designation: 'উপজেলা মাধ্যমিক শিক্ষা অফিসার', mobile: '০১৭১৮-২৪২৬৭৮' },
    ],
  },
};
